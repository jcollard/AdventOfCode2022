...
public class PacketTest
{
    ...
    public void TestEmptyListToString()
    {
        ...
        Assert.Equal("[]", Packets.ListToString(empty));
    }
    ...
    public void TestSingletonListToString()
    {
        ...
        Assert.Equal("[1]", Packets.ListToString(singleton));
    }
    ...
    public void TestHomogenousListToString()
    {
        ...
        Assert.Equal("[1,2,3,4]", Packets.ListToString(homogenous));
    }
    ...
    public void TestMixedListToString()
    {
        ...
        Assert.Equal("[1,[2,3,4],5,[6,7]]", Packets.ListToString(mixed));
    }
    ...
    public void TestNextedListToString()
    {
        ...
        Assert.Equal("[[1,[2,3]],[[4,5],[[7],[8]]]]", Packets.ListToString(nested));
    }

    [Fact]
    public void TestCompareInt()
    {
        Assert.Equal(0, Packets.CompareElements(100, 100));
        Assert.Equal(-1, Packets.CompareElements(50, 75));
        Assert.Equal(1, Packets.CompareElements(360, -50));
    }
